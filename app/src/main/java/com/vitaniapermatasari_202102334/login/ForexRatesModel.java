...
{
    private double BOB, BRL, BSD, BTC, BTN, BWP, BYN, BZD, CAD, CDF, IDR;

    public ForexRatesModel(){}

    public double getBOB(){return BOB;}

    public void setBOB(double BOB){this.BOB = BOB;}

    public double getBRL(){return BRL;}

    public void setBRL(double BRL){this.BRL = BRL;}

    public double getBSD(){return BSD;}

    public void setBSD(double BSD){this.BSD = BSD;}

    public double getBTC(){return BTC;}

    public void setBTC(double BTC){this.BTC = BTC;}

    public double getBTN(){return BTN;}

    public void setBTN(double BTN){this.BTN = BTN;}

    public double getBWP(){return BWP;}

    public void setBWP(double BWP){this.BWP = BWP;}

    public double getBYN(){return BYN;}

    public void setBYN(double BYN){this.BOB = BYN;}

    public double getBZD(){return BZD;}

    public void setBZD(double BZD){this.BZD = BZD;}
    ...
    public void setCDF(double CDF){this.CDF = CDF;}
