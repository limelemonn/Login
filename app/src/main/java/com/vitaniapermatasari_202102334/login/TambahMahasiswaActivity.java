...
public class TambahMahasiswaActivity extends AppCompatActivity
{
    ...
    private EditText _alamatEditText,_namaEditText,_nimEditText,_tahunMasukEditText,_tanggallahirEditTex;
    private EditText _tempatLahirEditText;
    private Spinner _jenisKelamin,_jpSpinner,_statusNikahSpinner;
    ...
    private void initSaveButton(){
        ...
        _saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String jenisKelamin = _jenisKelamin.getSelectedItem().toString();
                ...
                String tanggalLahir = _tanggallahirEditTex.getText().toString();
    ...
    private void initInputs(){
        _alamatEditText = findViewById(R.id.alamatEditText1  );
        _jenisKelamin = findViewById(R.id.JenisKelaminEditText);
        ...
        _statusNikahSpinner = findViewById(R.id.statuspernikahan);
        _tahunMasukEditText= findViewById(R.id.tahunmasukEditText);
        _tanggallahirEditTex = findViewById(R.id.tanggallahirEditText);
        _tempatLahirEditText = findViewById(R.id.tanggallahirEditText);
    }
}
